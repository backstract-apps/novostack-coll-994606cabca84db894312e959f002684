...
async def get_b_user(db: Session, id: str, user_name: str):
...
async def post_b_user(db: Session, id: str, first_name: str, last_name: str, age: int, pincode: int):


    record_to_be_added = {'id': age, 'user_name': id}
